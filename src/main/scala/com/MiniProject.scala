...
//    val blobPath = s"abfss://${containerName}@${storageAccountName}.blob.core.windows.net/${blobName}"
    ...
    spark.conf.set(s"fs.azure.account.key.${storageAccountName}.blob.core.windows.net",  storageKeyValue)
